...
<div class="min-h-full">
  <nav class="bg-gray-800/50">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/about" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">About</a>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="/about" aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">About</a>
  ...
  <main>
  <div class="w-full max-w-5xl mx-auto px-6 py-12 md:py-24">
    <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20">
        ...
        <div class="w-full md:w-3/5 text-center md:text-left space-y-6">
            ...
            <div class="pl-4 space-y-2 text-slate-400 text-base md:text-lg">
                <p class="font-medium">
        ...
        <div class="w-full md:w-2/5 flex justify-center md:justify-end">
            <div class="relative group">
                <div class="absolute -inset-1 transition-all duration-300 from-blue-600 to-cyan-500 rounded-2xl blur opacity-20"></div>
                
                <img src="img/profil.jpeg" alt="Foto Profil" class="relative w-64 h-64 md:w-80 md:h-80 object-cover rounded-2xl">
            </div>
        </div>
