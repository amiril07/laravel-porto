...
<div class="min-h-full">
  <nav class="bg-gray-800/50">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/contact" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">Contact</a>
              <a href="/project" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300">Projects</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="/contact" aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Contact</a>
        <a href="/project" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Projects</a>
      </div>
  ...
  <main>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-4">
        <a href="https://www.instagram.com/amiril.ma_/" target="_blank" 
           class="flex items-center gap-2 text-sky-400 font-bold px-6 py-2.5 rounded-full text-2xl">
           Instagram:<span class="text-fuchsia-500"> @amiril.ma_</span>
        </a>
        
        <a href="https://wa.me/6282164360612" target="_blank" 
           class="flex items-center gap-2 text-sky-400 font-bold px-6 py-2.5 rounded-full text-2xl">
           WhatsApp: <span class="text-lime-500">My WhatsApp</span>
        </a>
    </div>
</div>
  </main>
