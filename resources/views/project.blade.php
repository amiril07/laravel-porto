...
<div class="min-h-full">
  <nav class="bg-gray-800/50">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/project" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">Projects</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
        <a href="/home" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
        ...
        <a href="/project" aria-current="page" class="block rounded-md px-3 py-2 text-base font-medium text-white">Projects</a>
      </div>
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="img/profil.jpeg" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Muhammad Amiril M.A</div>
            <div class="text-sm font-medium text-gray-400">mamiril@gmail.com</div>
          </div>
  ...
  <main>
    ...
    <div class="w-full h-52 overflow-hidden bg-slate-900">
        <img src="img/image.png" alt="Damat" 
    ...
    <div class="p-6 space-y-4">
        ...
        Damat (Dana Cermat) adalah aplikasi pencatatan keuangan personal berbasis web yang dirancang untuk membantu pengguna melacak saldo bersih, mengelola anggaran bulanan, serta memantau arus kas harian melalui visualisasi grafik yang interaktif.
        </p>
        ...
        <div class="flex flex-wrap gap-2 pt-2">
            ...
            <span class="text-xs font-medium text-slate-300 bg-slate-900/60 border border-slate-1000/50 px-3 py-1.5 rounded-lg">CSS</span>
